...
# Ensure the mcp_server package is in sys.path
# PROJECT_ROOT_DIR should be l:/mcp-server/sentient-brain
# This assumes env.py is in l:/mcp-server/sentient-brain/mcp_server/alembic/
...
# This is where we will get the DATABASE_URL from our application's settings
...
def run_migrations_online() -> None:
    ...
    """
    # Use the engine from our application's database setup
    # connectable = engine_from_config(
    #     config.get_section(config.config_ini_section, {}),
    #     prefix="sqlalchemy.",
    #     poolclass=pool.NullPool,
    # )
    connectable = engine # Use the imported engine
